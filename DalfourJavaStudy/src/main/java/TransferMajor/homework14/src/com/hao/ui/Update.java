...
public class Update extends Application {
	...
	private Index index;
	// 写一个有参构造 接收学生对象
	public Update(Student stu1, Index index) {
		this.stu1 = stu1;
		this.index = index;
	}
	...
	public void start(Stage primaryStage) throws Exception {
		...
		tname.setText(stu1.getSname());
		tage.setText(String.valueOf(stu1.getSage()));
		...
		bok.setOnAction(ok -> {
			...
			// 把控件的值 封装为学生对象
			Student stu = new Student(stu1.getSid(), sname, ssex, sage, saddress);
