...
​	这种情况需要使用深克隆，编写带有全部参数的Citation构造方法，Student类中重写clone方法，在Citation类中的clone方法里实例化一个新的Citation实例，传入所有参数，参数调用Student类的clone方法，代码如下：
...
public class Citation implements Cloneable {
    ...
    @Override
    public Citation clone() throws CloneNotSupportedException {
        Citation citation = new Citation(stu.clone())
        return citation;
    }
}
